...
export default function TicketList() {
    ...
    const handleShow = (ticketId, modal) => {
    ...
    return (
        <>
            <Row>
                ...
                <Col xs={2}>
                    <Button variant='outline-primary' onClick={() => { handleShow(ticket.ticketId, "Export") }}>Export File</Button>
                </Col>
            </Row>
                            ...
                            <Card>
                                <Card.Body>
                                    ...
                                    <Button
                                        ...
                                        className="me-2"
                                        size="sm"
                                        onClick={() => handleShow(ticket.ticketId, "View")}
                                    >
                                        <i class="bi bi-eye-fill"></i> View
                                    </Button>
                                    {empRole != "3" && empID != ticket.assigneeId && (
                                        <>
                                            <Button
                                                variant="outline-success"
                                                className="me-2"
                                                size="sm"
                                                onClick={() => handleShow(ticket.ticketId, "Update")}
                                            >
                                            ...
                                            <Button
                                                ...
                                                size="sm"
                                                onClick={() => handleShow(ticket.ticketId, "Delete")}
                                            >
